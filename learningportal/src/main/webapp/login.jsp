...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="d-flex flex-column align-items-center justify-content-center vh-100">
                    <form method="post" action="loginController" class="w-75">
                        <h3 class="mb-3">Login to your account</h3>
                        <!-- Email input -->
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" name="email" id="uemail" placeholder="name@example.com" required>
                            <label for="uemail">Email address</label>
                        </div>
                        <!-- Password input -->
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" name="password" id="upass" placeholder="Password" required>
	...
	<script type="text/javascript">
		...
		if(status == "failed"){
			...
			{
				swal("Congratulations!","Signup sccessfull","success");
			}
	</script>
</body>
